...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public static final String TABLE_NAME_BLOOD_PRESSURE="blood_pressure";
    public static final String TABLE_NAME_BLOOD_SUGAR="blood_sugar";
...
//////////////////////////////////////
    ...
    public static final String BLOOD_PRESSURE_COL_ID = "bpId";
    public static final String BLOOD_PRESSURE_COL_DATE = "bpDate";
    public static final String BLOOD_PRESSURE_COL_TIME = "bpTime";
    public static final String BLOOD_PRESSURE_COL_SBP = "bpSBP";
    public static final String BLOOD_PRESSURE_COL_DBP = "bpDBP";
    public static final String BLOOD_PRESSURE_COL_BPM = "bpBPM";
    public static final String BLOOD_PRESSURE_COL_NOTE = "bpNote";
    public static final String BLOOD_PRESSURE_COL_PERSON_ID = "personId";


    static final String CREATE_TABLE_BLOOD_PRESSURE="CREATE TABLE "+TABLE_NAME_BLOOD_PRESSURE +" ( " +
            BLOOD_PRESSURE_COL_ID+" INTEGER PRIMARY KEY,"+
            BLOOD_PRESSURE_COL_DATE+" TEXT,"+
            BLOOD_PRESSURE_COL_TIME+" TEXT,"+
            BLOOD_PRESSURE_COL_SBP+" TEXT,"+
            BLOOD_PRESSURE_COL_DBP+" TEXT,"+
            BLOOD_PRESSURE_COL_BPM+" TEXT,"+
            BLOOD_PRESSURE_COL_NOTE+" TEXT,"+
            COL_FLAG+" TEXT,"+
            BLOOD_PRESSURE_COL_PERSON_ID+" TEXT)";


    ///////////////////////Blood Sugar/////////////////////////////////////////


    public static final String BLOOD_SUGAR_COL_ID = "bsId";
    public static final String BLOOD_SUGAR_COL_DATE = "bsDate";
    public static final String BLOOD_SUGAR_COL_TIME = "bsTime";
    public static final String BLOOD_SUGAR_COL_LEVEL = "bsLevel";
    public static final String BLOOD_SUGAR_COL_NOTES = "bsNotes";
    public static final String BLOOD_SUGAR_COL_PERSON_ID = "personId";
    ...
    static final String CREATE_TABLE_BLOOD_SUGAR="CREATE TABLE "+TABLE_NAME_BLOOD_SUGAR +" ( " +
            BLOOD_SUGAR_COL_ID+" INTEGER PRIMARY KEY,"+
            BLOOD_SUGAR_COL_DATE+" TEXT,"+
            BLOOD_SUGAR_COL_TIME+" TEXT,"+
            BLOOD_SUGAR_COL_LEVEL+" TEXT,"+
            BLOOD_SUGAR_COL_NOTES+" TEXT,"+
            COL_FLAG+" TEXT,"+
            BLOOD_PRESSURE_COL_PERSON_ID+" TEXT)";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_TABLE_BLOOD_SUGAR);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXIST "+TABLE_NAME_HOSPITAL);
        db.execSQL("DROP TABLE IF EXIST "+TABLE_NAME_BLOOD_PRESSURE);
        db.execSQL("DROP TABLE IF EXIST "+TABLE_NAME_BLOOD_SUGAR);
