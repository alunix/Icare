...
public class AddAppoinmentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClickAppointmentSave (View view)
    {
        ...
        {
            String flag = "A";
            String alarmCode = dataStorage.getAppointmentModelByAppointmentId(id).get(0).getAlarmCode();
            String notificationCode = dataStorage.getAppointmentModelByAppointmentId(id).get(0).getNotificationCode();
